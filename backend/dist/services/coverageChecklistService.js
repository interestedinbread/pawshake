 ...
 */
async function analyzeIncidentCoverage(policyId, incidentDescription, nChunks = 10) {
    try {
        // Validate input
        ...
        const allChunksPromises = coverageQueries.map((query) => (0, vectorService_1.querySimilarChunks)(query, Math.ceil(nChunks / coverageQueries.length), undefined, policyId));
...
//# sourceMappingURL=coverageChecklistService.js.map